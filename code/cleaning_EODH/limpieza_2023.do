********************************************************
* version 3:
* data cleaning for the 2023 movility survey
********************************************************
...
drop hora_ini hora_fin duracion_min t_acceso_min t_espera_min t_egreso_min modo_principal_agrupado modo_principal_desagrupado etapas app_antes_vj app_durante_vj genero orien_sexual identidad_etnica madre_cab_familia max_nivel_edu ocupacion_principal estra_hg
...
*******************************************************
// IDs. of where the home is localized
*******************************************************
...
*NO LA VAMOS A USAR PORQUE CON LOS OTROS DATOS ES SUFICIENTE PARA CREAR LA BDD
...
* i groupped all of these labels into 13 Estudia
...
* i groupped all of these labels into 29 "Jornalero/agricultor"
...
* i groupped all of these labels into 10 "Conductor/mensajero"
...
* i groupped all of these labels into 7 "Patrón o empleador"
...
* economically inactive conditions

replace ocupacion1 = 18 if strpos(ocupacion_principal, "Dedicado al hogar")

* i groupped all of these labels into 19 "Jubilado"
